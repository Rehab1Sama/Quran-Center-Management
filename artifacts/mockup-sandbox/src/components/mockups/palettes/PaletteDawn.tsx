export function PaletteDawn() {
  const p = {
    bg: "#FAFAF8",
    sidebar: "#D0D5EE",
    sidebarText: "#2A3460",
    sidebarActive: "#B8C0E0",
    attendanceBar: "#A0C4B4",
    achievementBar: "#EAC88A",
    button: "#5B6BA8",
    buttonText: "#FFFFFF",
    title: "#2A3460",
    description: "#6A7494",
    content: "#3A4268",
    stats: ["#5B6BA8", "#C49A3A", "#4FA89A", "#B06080"],
    cardBg: "#FFFFFF",
    border: "#E4E6F5",
  };
    ...
    <div dir="rtl" style={{ display: "flex", minHeight: "100vh", background: p.bg, fontFamily: "'Tajawal', sans-serif" }}>
      ...
      <div style={{ flex: 1, padding: 32, overflowY: "auto" }}>
        ...
        <div style={{ background: p.cardBg, border: `1px solid ${p.border}`, borderRadius: 12, padding: 20 }}>
          <div style={{ fontWeight: 600, fontSize: 14, color: p.title, marginBottom: 14 }}>🎨 لوحة ب — فجر الإشراق (ألوان الشعار الدافئة)</div>
