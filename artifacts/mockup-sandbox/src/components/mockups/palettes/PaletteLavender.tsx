export function PaletteLavender() {
  const palette = {
    bg: "#F4F3FA",
    sidebar: "#D8D4EE",
    sidebarText: "#4A4470",
    attendanceBar: "#9ECFC4",
    achievementBar: "#F0BCAD",
    button: "#8B83C7",
    buttonText: "#FFFFFF",
    title: "#2E2A4A",
    description: "#6B6680",
    content: "#3D3959",
    stats: ["#9B83C7", "#6BBFB5", "#E89BAA", "#8BAACC"],
    cardBg: "#FFFFFF",
    border: "#E4E1F5",
    sidebarActive: "#C5BFDF",
  };
    ...
    <div dir="rtl" style={{ display: "flex", minHeight: "100vh", background: palette.bg, fontFamily: "'Tajawal', 'Cairo', sans-serif" }}>
      ...
      <div style={{ flex: 1, padding: 32, overflowY: "auto" }}>
        ...
        <div style={{ background: palette.cardBg, border: `1px solid ${palette.border}`, borderRadius: 12, padding: 20 }}>
          <div style={{ fontWeight: 600, fontSize: 14, color: palette.title, marginBottom: 14 }}>🎨 لوحة ٢ — لافندر وفضي</div>
