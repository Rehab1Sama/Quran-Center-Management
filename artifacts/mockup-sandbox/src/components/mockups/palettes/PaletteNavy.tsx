export function PaletteNavy() {
  const p = {
    bg: "#F0F2F9",
    sidebar: "#C8CEEB",
    sidebarText: "#2E3A6E",
    sidebarActive: "#A8B2DC",
    attendanceBar: "#88BFBB",
    achievementBar: "#E8D09C",
    button: "#6B7BAF",
    buttonText: "#FFFFFF",
    title: "#2E3A6E",
    description: "#6B7899",
    content: "#3D4D70",
    stats: ["#8891CC", "#6BBAB5", "#D4A84B", "#C07898"],
    cardBg: "#FFFFFF",
    border: "#DDE1F0",
  };
    ...
    <div dir="rtl" style={{ display: "flex", minHeight: "100vh", background: p.bg, fontFamily: "'Tajawal', sans-serif" }}>
      ...
      <div style={{ flex: 1, padding: 32, overflowY: "auto" }}>
        ...
        <div style={{ background: p.cardBg, border: `1px solid ${p.border}`, borderRadius: 12, padding: 20 }}>
          <div style={{ fontWeight: 600, fontSize: 14, color: p.title, marginBottom: 14 }}>🎨 لوحة أ — بحري سماوي (ألوان الشعار)</div>
